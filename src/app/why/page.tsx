    ...
    items: [
      {
        ...
        description:
          "60 премий. Твоя идея может победить — и это признание на уровне всего холдинга.",
      },
      {
...
const letterSections: LetterSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Помимо 60 премий и признания на уровне всего холдинга — вы получаете навык, который будет цениться везде. Умение видеть, где AI может помочь — это компетенция, за которую через год-два будут доплачивать.",
