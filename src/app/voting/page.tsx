      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Модель голосования EAI Challenge
          </h1>
              ...
              <div className="space-y-0">
                ...
                {commissionPct > 0 && (
                  <div className="timeline-step" style={{ color: "#a78bfa" }}>
                    ...
                    <p className="text-sm mt-1" style={{ color: "#8898b8" }}>
                      Комиссия из представителей сотрудников, руководства и акционеров оценивает топ-5 каждого дивизиона. Их оценка добавляется к народному рейтингу.
                    </p>
                  </div>
                )}
