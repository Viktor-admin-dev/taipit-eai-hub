...
const steps = [
  ...
  },
  {
    ...
    description: "По всем поданным проектам формируется рейтинг. Комиссия проверяет топ-5 — чтобы всё было честно и реализуемо.",
    color: "#a78bfa",
  },
  {
    icon: "🎉",
    title: "Победители получают премии",
    description: "Топ-3 в каждом дивизионе получают премию. Всего 30 победителей. Лучшие презентуют свои идеи на общей встрече.",
    color: "#4ade80",
  },
];
