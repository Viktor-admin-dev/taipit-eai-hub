              ...
              <div className="space-y-0">
                ...
                {commissionPct > 0 && (
                  <div className="timeline-step" style={{ color: "#a78bfa" }}>
                    ...
                    <p className="text-sm mt-1" style={{ color: "#8898b8" }}>
                      Комиссия из представителей сотрудников, руководства и учредителей оценивает топ-30 заявок в рейтинге. Их оценка добавляется к народному рейтингу.
                    </p>
                  </div>
                )}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p style={{ color: "#8898b8" }}>
                ...
                и ~30% комиссии (стратегический фильтр). Комиссия: 1 представитель сотрудников + 1 от руководства + 1 от учредителей — всего 3 человека, решения принимаются большинством.
              </p>
            </div>
          </div>
        </div>
