...
const slides: Slide[] = [
  {
    ...
    subtitle:
      "4 директора из 55-го дивизиона рассказывают, как AI изменил их работу. Предложи свою идею — 60 премий ждут авторов лучших решений.",
  ...
  },
  {
    ...
    subtitle:
      "Никто не заставляет становиться экспертом за ночь. Задай вопрос на форуме, почитай истории коллег, а когда будешь готов — предложи свою идею. 60 премий для тех, кто попробует.",
    antiFear:
